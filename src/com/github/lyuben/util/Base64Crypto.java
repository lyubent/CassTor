...
public abstract class Base64Crypto {
     ...
     * 
     * @param cypher - Encrypted string requiring decoding.
    ...
    /**
     * Encodes a plain string into double BASE64 Reasoning behind double encoding
     * It removes the '==' at the end of the string obfuscating the encoding.
     * 
     * @param plain Requires a string to encode.
